AFRAME.registerComponent("wire-fence", {
    init: function () {
        ...
        for (var i = 0; i < 10; i++) {
            ...
            //set the id
            wireFence1.setAttribute("id", "wireFence" +i);
            wireFence2.setAttribute("id", "wireFence" +i);
            wireFence3.setAttribute("id", "wireFence" +i);
            wireFence4.setAttribute("id", "wireFence" +i);
            ...
            wireFence1.setAttribute(
                "gltf-model",
                "assets/models/barbed_wire_fence"
            );
